...
test(function () {
	...
	Assert::same([NULL, NULL], Reflection::combineArgs($method, []));
	Assert::same([NULL, NULL], Reflection::combineArgs($method, ['req' => NULL, 'opt' => NULL]));
	Assert::same([$method, NULL], Reflection::combineArgs($method, ['req' => $method, 'opt' => NULL]));
