...
class TestPresenter extends Application\UI\Presenter
{
	...
	protected function startup()
	{
		...
		Assert::same('/index.php?action=default&do=hint&presenter=Test', $this->link('hint!', [1], (object) [1]));
		...
		Assert::same('/index.php?action=default&do=hint&presenter=Test', $this->link('hint!', [new stdClass]));
		...
		Assert::same('/index.php?action=default&do=null&presenter=Test', $this->link('null!', [1], (object) [1]));
		...
		Assert::same('/index.php?action=default&do=null&presenter=Test', $this->link('null!', [new stdClass]));
	}
