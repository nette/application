...
class TestPresenter extends Application\UI\Presenter
{
	...
	protected function startup()
	{
		...
		Assert::same('/index.php?pint=0&pbool=0&action=params&presenter=Test', $this->link('params', ['pint' => FALSE, 'pbool' => FALSE, 'p' => FALSE, 'parr' => NULL]));
		...
		Assert::same('/index.php?int=0&action=hintsNulls&presenter=Test', $this->link('hintsNulls', ['int' => 0, 'bool' => FALSE, 'str' => '', 'arr' => []]));
		...
		Assert::same('/index.php?action=hintsNulls&presenter=Test', $this->link('hintsNulls', ['int' => new stdClass]));
		...
		Assert::same('/index.php?action=hintsDefaults&presenter=Test', $this->link('hintsDefaults', ['int' => new stdClass]));
		...
		Assert::same('/index.php?action=defaults&presenter=Test', $this->link('defaults', ['int' => new stdClass]));
		...
		Assert::same('/index.php?action=objects&presenter=Test', $this->link('objects', ['req' => new Exception, 'opt' => NULL]));
