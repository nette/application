...
class TestPresenter extends Application\UI\Presenter
{
	...
	protected function startup(): void
	{
		...
		}, E_USER_WARNING, "Invalid link: Value passed to persistent parameter 'pbool' in presenter Test must be bool, string given.");

		// exception invalid link mode
		$this->invalidLinkMode = self::InvalidLinkException;
		Assert::exception(function () {
			$this->link('params', ['p' => null, 'pbool' => 'a']);
		}, Nette\Application\UI\InvalidLinkException::class, "Value passed to persistent parameter 'pbool' in presenter Test must be bool, string given.");
