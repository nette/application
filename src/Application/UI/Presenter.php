...
abstract class Presenter extends Control implements Application\IPresenter
{
	...
	{
		$user = (array) PresenterComponentReflection::getAnnotation($element, 'User');
	...
	{
		return (array) PresenterComponentReflection::getAnnotation(Reflection\ClassType::from(get_called_class()), 'persistent');
	}
